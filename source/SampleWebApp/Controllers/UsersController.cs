...
namespace SampleWebApp.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var userId = id == null ? User.Identity.GetUserId() : id;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName")] ApplicationUser applicationUser)
        {
            ApplicationUser currentUser = db.Users.Find(applicationUser.Id);
